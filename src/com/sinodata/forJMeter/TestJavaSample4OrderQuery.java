...
public class TestJavaSample4OrderQuery extends AbstractJavaSamplerClient{
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
		...
		try {
			...
			resultData = String.valueOf(hr.getResponseData4OrderQuery());

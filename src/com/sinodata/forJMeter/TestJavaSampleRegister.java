...
public class TestJavaSampleRegister extends AbstractJavaSamplerClient{
	...
	public Arguments getDefaultParameters() {
		...
		params.addArgument("ipAndPort", "10.10.37.146:8099");
		...
		params.addArgument("Token", "default");
		
		params.addArgument("UserName", "china001");
		params.addArgument("RealName", "中国人");
		params.addArgument("IdCard", "520401197212281580");
		params.addArgument("MobileCode", "18923780320");
		params.addArgument("LoginPass", "123456");
		params.addArgument("TradePass", "123456");
		params.addArgument("SmsCode", "");
		params.addArgument("InviteCode", "");
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
		...
		sr.setSampleLabel("Java请求(广电微信接入用户注册)");//察看结果树的标题显示
		...
		try {
			...
			sr.setRequestHeaders("测试广电微信接入用户注册");
			
			// 通过下面的操作可以将被测方法的响应输出到Jmeter的察看结果树中的响应数据里。
			String uri = "/api/access/do?cmd=register&";

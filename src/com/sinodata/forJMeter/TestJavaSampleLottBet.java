...
public class TestJavaSampleLottBet extends AbstractJavaSamplerClient{
	...
	public Arguments getDefaultParameters() {
		...
		params.addArgument("Station", "");
		params.addArgument("GameId", "");
		params.addArgument("SellTermCode", "");
		params.addArgument("Money", "");
		params.addArgument("DrawWay", "");
		params.addArgument("CheckCode", "default");
		params.addArgument("CodeInfo", "");
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
		...
		sr.setSampleLabel("Java请求(投注(自助终端))");//察看结果树的标题显示
		...
		while (it.hasNext()){
			...
			if ("CheckCode".equals(key)){
				if("default".equals(value)){
					...
					sb.append(arg0.getParameter("RunCode"));
					sb.append(arg0.getParameter("CodeInfo"));
					sb.append(arg0.getParameter("Money"));
					System.out.println(arg0.getParameter("RunCode"));
					System.out.println(arg0.getParameter("CodeInfo"));
					System.out.println(arg0.getParameter("Money"));
		...
		try {
			...
			sr.setRequestHeaders("测试投注(自助终端)");
			
			// 通过下面的操作可以将被测方法的响应输出到Jmeter的察看结果树中的响应数据里。
			String uri = "/api/access/lottBet?";

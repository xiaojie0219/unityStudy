...
public class TestJavaSampleSendSms extends AbstractJavaSamplerClient{
	...
	public Arguments getDefaultParameters() {
		...
		params.addArgument("agentSecretKey", "C3F1E6B25312648DDF122DB8");
		params.addArgument("DES3", "zhongxinyinhang123456789");
		
		params.addArgument("PartnerId", "00008");
		...
		params.addArgument("Mobile", "18923780320");
		params.addArgument("RequestType", "1");
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
		...
		sr.setSampleLabel("Java请求(广电微信接入发送短信)");//察看结果树的标题显示

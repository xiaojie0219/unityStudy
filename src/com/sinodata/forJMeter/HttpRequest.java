...
public class HttpRequest {
	...
	public byte[] sendPost4QueryPrize() throws UnsupportedEncodingException{
		byte[] data = requestDataQueryPrize();
		
		String url = "http://" + ipAndPort
				+ "/api/access/do?cmd=queryPrize&partnerId="
				+ mapData.get("PartnerId") + "&hashType=md5&hash=" + MD5Security.getMD5String(data);
	...
	public byte[] sendPost4Auth() throws UnsupportedEncodingException{
	...
	public String getResponseDataQueryPrize() throws UnsupportedEncodingException, Exception{
		return new String(threeDES.decryptMode(sendPost4QueryPrize(), agentSecretKey),"UTF-8");
	}
	
	public String getResponseDataAuth() throws UnsupportedEncodingException, Exception{
		return new String(threeDES.decryptMode(sendPost4Auth(), agentSecretKey),"UTF-8");
	}

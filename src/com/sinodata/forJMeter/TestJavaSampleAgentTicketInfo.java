...
public class TestJavaSampleAgentTicketInfo extends AbstractJavaSamplerClient{
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
		...
		sr.setSampleLabel("Java请求(验票查询)");//察看结果树的标题显示
		...
		try {
			...
			sr.setRequestHeaders("测试验票查询");
			
			// 通过下面的操作可以将被测方法的响应输出到Jmeter的察看结果树中的响应数据里。
			resultData = String.valueOf(hr.getResponseData4AgentTicketInfo());

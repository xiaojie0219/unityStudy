...
public class TestJavaSampleImageTicket extends AbstractJavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
		...
		sr.setSampleLabel("Java请求(使用图片查询彩票信息)");//察看结果树的标题显示
		...
		map.put("ImageUrl", arg0.getParameter("ImageUrl"));
		try {
			...
			resultData = String.valueOf(hr.getResponseData4ImageTicket());

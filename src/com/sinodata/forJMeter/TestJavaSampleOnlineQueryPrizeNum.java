...
public class TestJavaSampleOnlineQueryPrizeNum extends AbstractJavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
		...
		sr.setSampleLabel("Java请求(开奖号码查询queryPrizeNum)");//察看结果树的标题显示
		...
		try {
			...
			String uri = "/api/online/do?cmd=queryPrizeNum&";
